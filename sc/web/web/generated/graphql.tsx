...
export function useGetUsersChatsQuery(
	options: Omit<Urql.UseQueryArgs<GetUsersChatsQueryVariables>, "query">
) {
...
export type LoginMutation = {
	...
	login: {
		__typename?: "AuthResponse";
		token: string;
		errors: Array<{ __typename?: "Error"; method: string; message: string; field: string }>;
	};
};
...
export type GetUsersChatsQuery = {
	__typename?: "Query";
	getUsersChats: {
		__typename?: "ChatsResponse";
		...
		chats: Array<{
			...
			Members: Array<{
				__typename?: "User";
				name: string;
				base: { __typename?: "Base"; id: string };
			}>;
			Messages: Array<{
				__typename?: "Message";
				Body: string;
				Seen?: Array<string> | null;
				base: { __typename?: "Base"; createdAt: any };
