...
import (
	...
	"poetry-example/configreader"
	"poetry-example/db"
	poetry "poetry-example/proto"
...
func NewServer(port int) (Server, error) {
	...
	server.poetryDb = db.NewPoetryDb(config.PoetrydbBaseUrl, config.PoetrydbHttpTimeout)
